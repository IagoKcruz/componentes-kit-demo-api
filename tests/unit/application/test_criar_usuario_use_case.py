...
async def test_criar_usuario_email_duplicado_levanta_excecao(uow):
    uow.usuarios.buscar_por_email.return_value = object()
...
async def test_criar_usuario_cpf_duplicado_levanta_excecao(uow):
    uow.usuarios.buscar_por_email.return_value = None
    uow.usuarios.buscar_por_cpf.return_value = object()
...
async def test_criar_usuario_retorna_dto(uow):
    uow.usuarios.buscar_por_email.return_value = None
    uow.usuarios.buscar_por_cpf.return_value = None
